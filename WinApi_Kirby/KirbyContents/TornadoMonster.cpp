...
void TornadoMonster::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Tornado_Monster_Death", "Right_TornadoEnermy.Bmp", 14, 21, 0.3f, false);
		...
		MainRenderer->CreateAnimation("Left_Tornado_Monster_Death", "Left_TornadoEnermy.Bmp", 14, 21, 0.3f, false);
