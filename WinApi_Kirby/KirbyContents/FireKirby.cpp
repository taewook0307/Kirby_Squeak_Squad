...
void FireKirby::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Fire_JumpToDrop", "Right_FireKirby.Bmp", 28, 35, 0.03f, false);
		...
		MainRenderer->CreateAnimation("Left_Fire_JumpToDrop", "Left_FireKirby.Bmp", 28, 35, 0.03f, false);
