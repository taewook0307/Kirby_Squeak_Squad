...
void SparkKirby::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Spark_Damage", "Right_SparkKirby.Bmp", 130, 136, 0.1f, false);
		...
		MainRenderer->CreateAnimation("Left_Spark_Damage", "Left_SparkKirby.Bmp", 130, 136, 0.1f, false);
