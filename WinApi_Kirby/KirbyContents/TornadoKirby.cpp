...
void TornadoKirby::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Tornado_JumpToDrop", "Right_TornadoKirby.Bmp", 28, 35, 0.03f, false);
		...
		MainRenderer->CreateAnimation("Right_Tornado_BreatheOutLand", "Right_TornadoKirby.Bmp", 106, 107, 0.1f, false);
		...
		MainRenderer->CreateAnimation("Right_Tornado_FlyToTurnUp", "Right_TornadoKirby.Bmp", 110, 121, 0.1f, false);
		MainRenderer->CreateAnimation("Right_Tornado_FlyToTurnLand", "Right_TornadoKirby.Bmp", 122, 123, 0.1f, true);
		...
		MainRenderer->CreateAnimation("Left_Tornado_JumpToDrop", "Left_TornadoKirby.Bmp", 28, 35, 0.03f, false);
		...
		MainRenderer->CreateAnimation("Left_Tornado_BreatheOutLand", "Left_TornadoKirby.Bmp", 106, 107, 0.1f, false);
		...
		MainRenderer->CreateAnimation("Left_Tornado_FlyToTurnUp", "Left_TornadoKirby.Bmp", 110, 121, 0.1f, false);
		MainRenderer->CreateAnimation("Left_Tornado_FlyToTurnLand", "Left_TornadoKirby.Bmp", 122, 123, 0.1f, true);
