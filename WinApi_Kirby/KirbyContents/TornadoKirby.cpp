...
void TornadoKirby::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Tornado_FlyToTurnUp", "Right_TornadoKirby.Bmp", 110, 121, 0.2f, false);
		...
		MainRenderer->CreateAnimation("Left_Tornado_FlyToTurnUp", "Left_TornadoKirby.Bmp", 110, 121, 0.2f, false);
