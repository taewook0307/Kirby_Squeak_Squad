...
void Kirby::Start()
{
	...
	}
	{
		...
		MainRenderer->CreateAnimation("Right_JumpToDown", "Right_Kirby.Bmp", 15, 22, 0.05f, false);
		...
		MainRenderer->CreateAnimation("Left_JumpToDown", "Left_Kirby.Bmp", 15, 22, 0.05f, false);
