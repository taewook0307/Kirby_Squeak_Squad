...
void Kirby::Start()
{
	...
	}
	{
		...
		MainRenderer->CreateAnimation("Right_Stop", "Right_Kirby.Bmp", 42, 42, 0.1f, true);
		MainRenderer->CreateAnimation("Right_StopToIdle", "Right_Kirby.Bmp", 43, 44, 0.2f, false);
		MainRenderer->CreateAnimation("Right_Breathe", "Right_Kirby.Bmp", 45, 50, 0.2f, false);
		MainRenderer->CreateAnimation("Right_Fly", "Right_Kirby.Bmp", 51, 68, 0.2f, true);
		MainRenderer->CreateAnimation("Right_BreatheOutLand", "Right_Kirby.Bmp", 69, 70, 0.1f, false);
		MainRenderer->CreateAnimation("Right_BreatheOut", "Right_Kirby.Bmp", 69, 70, 0.2f, true);
		MainRenderer->CreateAnimation("Right_Drop", "Right_Kirby.Bmp", 71, 72, 0.2f, false);
		MainRenderer->CreateAnimation("Right_FlyToLand", "Right_Kirby.Bmp", 84, 86, 0.3f, true);
		MainRenderer->CreateAnimation("Right_FlyToTurnUp", "Right_Kirby.Bmp", 73, 79, 0.2f, false);
		MainRenderer->CreateAnimation("Right_FlyToTurnLand", "Right_Kirby.Bmp", 80, 83, 0.2f, false);
		MainRenderer->CreateAnimation("Right_LevelMove", "Right_Kirby.Bmp", 87, 90, 0.1f, false);
		MainRenderer->CreateAnimation("Right_Damage", "Right_Kirby.Bmp", 91, 93, 0.2f, false);
		MainRenderer->CreateAnimation("Right_DamageLand", "Right_Kirby.Bmp", 94, 95, 0.3f, false);
		MainRenderer->CreateAnimation("Right_AttackReady", "Right_Kirby.Bmp", 96, 99, 0.1f, false);
		MainRenderer->CreateAnimation("Right_AttackLoop", "Right_Kirby.Bmp", 100, 101, 0.1f, true);
		MainRenderer->CreateAnimation("Right_Keep", "Right_Kirby.Bmp", 102, 108, 0.1f, false);
		MainRenderer->CreateAnimation("Right_Attack", "Right_Kirby.Bmp", 109, 113, 0.1f, false);
		MainRenderer->CreateAnimation("Right_KeepIdle", "Right_Kirby.Bmp", 123, 124, 0.5f, true);
		MainRenderer->CreateAnimation("Right_KeepWalk", "Right_Kirby.Bmp", 133, 144, 0.05f, true);
		...
		MainRenderer->CreateAnimation("Left_Stop", "Left_Kirby.Bmp", 42, 42, 0.1f, true);
		MainRenderer->CreateAnimation("Left_StopToIdle", "Left_Kirby.Bmp", 43, 44, 0.2f, false);
		MainRenderer->CreateAnimation("Left_Breathe", "Left_Kirby.Bmp", 45, 50, 0.2f, false);
		MainRenderer->CreateAnimation("Left_Fly", "Left_Kirby.Bmp", 51, 68, 0.2f, true);
		MainRenderer->CreateAnimation("Left_BreatheOutLand", "Left_Kirby.Bmp", 69, 70, 0.1f, false);
		MainRenderer->CreateAnimation("Left_BreatheOut", "Left_Kirby.Bmp", 69, 70, 0.2f, true);
		MainRenderer->CreateAnimation("Left_Drop", "Left_Kirby.Bmp", 71, 72, 0.2f, false);
		MainRenderer->CreateAnimation("Left_FlyToLand", "Left_Kirby.Bmp", 84, 86, 0.3f, true);
		MainRenderer->CreateAnimation("Left_FlyToTurnUp", "Left_Kirby.Bmp", 73, 79, 0.2f, false);
		MainRenderer->CreateAnimation("Left_FlyToTurnLand", "Left_Kirby.Bmp", 80, 83, 0.2f, false);
		MainRenderer->CreateAnimation("Left_LevelMove", "Left_Kirby.Bmp", 87, 90, 0.1f, false);
		MainRenderer->CreateAnimation("Left_Damage", "Left_Kirby.Bmp", 91, 93, 0.2f, false);
		MainRenderer->CreateAnimation("Left_DamageLand", "Left_Kirby.Bmp", 94, 95, 0.3f, false);
		MainRenderer->CreateAnimation("Left_AttackReady", "Left_Kirby.Bmp", 96, 99, 0.1f, false);
		MainRenderer->CreateAnimation("Left_AttackLoop", "Left_Kirby.Bmp", 100, 101, 0.1f, true);
		MainRenderer->CreateAnimation("Left_Keep", "Left_Kirby.Bmp", 102, 108, 0.1f, false);
		MainRenderer->CreateAnimation("Left_Attack", "Left_Kirby.Bmp", 109, 113, 0.1f, false);
		MainRenderer->CreateAnimation("Left_KeepIdle", "Left_Kirby.Bmp", 123, 124, 0.5f, true);
		MainRenderer->CreateAnimation("Left_KeepWalk", "Left_Kirby.Bmp", 133, 144, 0.05f, true);
