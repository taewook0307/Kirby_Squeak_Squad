...
void IceKirby::Start()
{
...

	{
		...
		MainRenderer->CreateAnimation("Right_Ice_Damage", "Right_IceKirby.Bmp", 94, 98, 0.1f, false);
		...
		MainRenderer->CreateAnimation("Left_Ice_Damage", "Left_IceKirby.Bmp", 94, 98, 0.1f, false);
